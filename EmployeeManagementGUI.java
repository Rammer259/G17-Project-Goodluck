...
public class EmployeeManagementGUI{
	...
	/**
	 *This nethid removes any line that has the first and last name present
	 *Created because of an error when we linked GUI to other remove method
	 * @param String
	 * @throws IOException
	...
	public void removal_GUI(String firstName, String lastName)throws IOException, FileNotFoundException {
		...
		while((currentLine = reader.readLine()) != null) {
			...
			if(trimmed.contains(first) && trimmed.contains(last)) continue;
