...
/*
 * This class utilizes methods from the EmployeeManagement superclass and allows the user to loop through the menu
 * 
 * @author Akshat Passi
...
public class MenuTools extends EmployeeManagement {
	...
	public void loop() throws IOException {
		while (!choice.equalsIgnoreCase("X")) {
			// if the user chooses to add employees, the user can add until they enter
			// '/quit'
			...
			// if the user chooses to view employees, display all employees line by line by
			// calling the ReadFile class.
			...
			// Calls the numEmployees method, takes the current file as the argument, and
